...
insert into userDetails(username,password) values('advisor','90855e629cbebcc7db5dfc4d79dafa06');
    ...
    insert into questions(question,post_date,user_name,tag)   values
                ...
                ('<p>How to write insert command in sql ?</p>',CURRENT_TIMESTAMP(0),'Bipilesh','math'),
                ('<p>How to use spring ?</p>',CURRENT_TIMESTAMP(0),'Sandeep','javaSpring'),
                ('<p>What is servlet ?</p>',CURRENT_TIMESTAMP(0),'Bipilesh','Programming'),
                ('<p>Can i use driver for connection to database ?</p>',CURRENT_TIMESTAMP(0),'Anil','travel'),
                ('<p>Who is father of computer ?</p>',CURRENT_TIMESTAMP(0),'Anil','Computer'),
                ('<p>How to create android application ?</p>',CURRENT_TIMESTAMP(0),'Sandeep','Andriod'),
                ('<p>How to use intellej for web application</p>',CURRENT_TIMESTAMP(0),'Bipilesh','IDE'),
                ('<p>Where is Marina Beach in India ?</p>',CURRENT_TIMESTAMP(0),'Sandeep','Biology'),
                ('<p>How is it one careless match can start a forest fire, but it takes a whole box to start a campfire?</p>',CURRENT_TIMESTAMP(0),'Sandeep','Fire'),
                ('<p>Whats your name in you office?</p>',CURRENT_TIMESTAMP(0),'Sandeep','General'),
                ('<p>Whats your pet animal name?</p>',CURRENT_TIMESTAMP(0),'Sandeep',' '),
                ('<p>Whats your pet name?</p>',CURRENT_TIMESTAMP(0),'Sandeep',' '),
                ('<p>Whats your nick name?</p>',CURRENT_TIMESTAMP(0),'Sandeep','Person'),
                ('<p>Whats your father name?</p>',CURRENT_TIMESTAMP(0),'Sandeep','family'),
                ('<p>Whats your mother name?</p>',CURRENT_TIMESTAMP(0),'Sandeep','family'),
                ('<p>Whats your school name?</p>',CURRENT_TIMESTAMP(0),'Sandeep','education'),
                ('<p>Whats your native name?</p>',CURRENT_TIMESTAMP(0),'Ajith','family'),
                ('<p>Whats your favourite food?</p>',CURRENT_TIMESTAMP(0),'Sandeep','Food'),
                ('<p>Whats your favourite play?</p>',CURRENT_TIMESTAMP(0),'Sandeep','sport'),
                ('<p>Whats your surname?</p>',CURRENT_TIMESTAMP(0),'Sandeep',' '),
                ('<p>Whats your middle name?</p>',CURRENT_TIMESTAMP(0),'Sandeep','NAMES'),
                ('<p>Whats your lastname?</p>',CURRENT_TIMESTAMP(0),'Sandeep','travel'),
                ('<p>Whats your good name?</p>',CURRENT_TIMESTAMP(0),'Sandeep',' '),
                ('<p>Where are you from? / Where do you come from?</p>',CURRENT_TIMESTAMP(0),'Sandeep','travel'),
                ('<p>Whats your surname / family name?</p>',CURRENT_TIMESTAMP(0),'Sandeep','java'),
                ('<p>Whats your first name?</p>',CURRENT_TIMESTAMP(0),'Ravi','science'),
                ('<p>Whats your address?</p>',CURRENT_TIMESTAMP(0),'Sandeep','Biology'),
                ('<p>Where do you live?</p>',CURRENT_TIMESTAMP(0),'Sandeep','database'),
                ('<p>Whats your (tele)phone number?</p>',CURRENT_TIMESTAMP(0),'Sandeep','English'),
                ('<p>How old are you?</p>',CURRENT_TIMESTAMP(0),'Sandeep','Biology'),
                ('<p>When / Where were you born?</p>',CURRENT_TIMESTAMP(0),'Sandeep','science'),
                ('<p>Are you married? / Whats your marital status?</p>',CURRENT_TIMESTAMP(0),'Sandeep','travel'),
                ('<p>What do you do? / Whats your job?</p>',CURRENT_TIMESTAMP(0),'Sandeep',' '),
                ('<p>Where did you go?</p>',CURRENT_TIMESTAMP(0),'Sandeep','math'),
                ('<p>What did you do?</p>',CURRENT_TIMESTAMP(0),'Sandeep','Biology'),
                ('<p>Where were you?</p>',CURRENT_TIMESTAMP(0),'Sandeep','science'),
                ('<p>Have you got a car / job / house / etc.?</p>',CURRENT_TIMESTAMP(0),'Sandeep','Car'),
                ('<p>Have you got any children / friends / books / etc.?</p>',CURRENT_TIMESTAMP(0),'Sandeep','General'),
...
insert into answers(q_id,answer,post_date,user_name) values((select MAX(q_id) from questions),'answer for 7 question . 4',CURRENT_TIMESTAMP(0),'Gaurav');
insert into answers(q_id,answer,post_date,user_name) values((select MAX(q_id) from questions),'answer for 7 question . 5',CURRENT_TIMESTAMP(0),'Ajit');
insert into answers(q_id,answer,post_date,user_name) values((select MAX(q_id) from questions),'answer for 7 question . 6',CURRENT_TIMESTAMP(0),'Prasath');
insert into answers(q_id,answer,post_date,user_name) values((select MAX(q_id) from questions),'answer for 7 question . 7',CURRENT_TIMESTAMP(0),'Ravi');
insert into answers(q_id,answer,post_date,user_name) values((select MAX(q_id) from questions),'answer for 7 question . 8',CURRENT_TIMESTAMP(0),'Prakash') ;
insert into answers(q_id,answer,post_date,user_name) values((select MAX(q_id) from questions),'answer for 7 question . 8',CURRENT_TIMESTAMP(0),'Gaurav');
--
