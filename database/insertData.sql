...
insert into userDetails(username,password) values('advisor','90855e629cbebcc7db5dfc4d79dafa06');
    ...
    insert into questions(question,post_date,user_name,tag)   values
                ...
                ('<p>How to use spring ?</p>',CURRENT_TIMESTAMP(0),'Sandeep','math'),
                ('<p>What is servlet ?</p>',CURRENT_TIMESTAMP(0),'Bipilesh','math'),
                ('<p>Can i use driver for connection to database ?</p>',CURRENT_TIMESTAMP(0),'Anil','travel'),
                ('<p>Who is father of computer ?</p>',CURRENT_TIMESTAMP(0),'Anil','Biology'),
                ('<p>How to create android application ?</p>',CURRENT_TIMESTAMP(0),'Sandeep','science'),
                ('<p>How to use intellej for web application</p>',CURRENT_TIMESTAMP(0),'Bipilesh','java'),
                ('<p>Where is Marina Beach in India ?</p>',CURRENT_TIMESTAMP(0),'Sandeep','Biology'),
                ('<p>How is it one careless match can start a forest fire, but it takes a whole box to start a campfire?</p>',CURRENT_TIMESTAMP(0),'Sandeep','java'),
                ('<p>Whats your name in you office?</p>',CURRENT_TIMESTAMP(0),'Sandeep','Biology'),
                ('<p>Whats your pet animal name?</p>',CURRENT_TIMESTAMP(0),'Sandeep',' '),
                ('<p>Whats your pet name?</p>',CURRENT_TIMESTAMP(0),'Sandeep',' '),
                ('<p>Whats your nick name?</p>',CURRENT_TIMESTAMP(0),'Sandeep','java'),
                ('<p>Whats your father name?</p>',CURRENT_TIMESTAMP(0),'Sandeep','travel'),
                ('<p>Whats your mother name?</p>',CURRENT_TIMESTAMP(0),'Sandeep','math'),
                ('<p>Whats your school name?</p>',CURRENT_TIMESTAMP(0),'Sandeep','science'),
                ('<p>Whats your native name?</p>',CURRENT_TIMESTAMP(0),'Sandeep','English'),
                ('<p>Whats your favourite food?</p>',CURRENT_TIMESTAMP(0),'Sandeep','math'),
                ('<p>Whats your favourite play?</p>',CURRENT_TIMESTAMP(0),'Sandeep','java'),
                ('<p>Whats your surname?</p>',CURRENT_TIMESTAMP(0),'Sandeep',' '),
                ('<p>Whats your middle name?</p>',CURRENT_TIMESTAMP(0),'Sandeep','English'),
                ...
                ('<p>Whats your first name?</p>',CURRENT_TIMESTAMP(0),'Sandeep','science'),
                ...
                ('<p>Have you got a car / job / house / etc.?</p>',CURRENT_TIMESTAMP(0),'Sandeep','java'),
                ('<p>Have you got any children / friends / books / etc.?</p>',CURRENT_TIMESTAMP(0),'Sandeep','English'),
