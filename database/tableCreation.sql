...
create table userDetails(username varchar(50),name varchar(50),password varchar(50),dob varchar(15),email varchar(50),location varchar(200),gender varchar(10),loginFailCount INT,sessionStartTime DATE,PRIMARY KEY (username));
