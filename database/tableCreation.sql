...
create table userDetails(username varchar(50),name varchar(50),password varchar(50),dob date,location varchar(50),gender varchar(10),loginFailCount INT,sessionStartTime DATE,PRIMARY KEY (username));
