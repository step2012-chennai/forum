    ...
    <div id="container">
       <div id="register">
           ...
           <label>Location:</label>
                 ...
                 <div class="input">
                 <input name="address" type="text" id="address"></input>
            ...
            <div class="input"><label>Email:</label> <input id="emailId" name="emailId" type="email"/> </div>
            <div class="input"><label>Password:</label> <input id="password" type="password" /> </div>

            <label>Confirm Password:</label> <input id="confirmPassword" name="password" type="password"  onChange="validatePassword()"/> <label id="myDiv1"></label><br/><br/>
            <div class="input">
