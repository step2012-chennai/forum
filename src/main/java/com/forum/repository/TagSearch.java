...
public class TagSearch {
    ...
    private List<Question> fetchTag(String searchTag) {
        ...
        SqlRowSet result = jdbcTemplate.queryForRowSet("select q.q_id,q.question,q.post_date,q.user_name,t.tag_name from questions q join questions_tags qt on q.q_id=qt.q_id join tags t on t.t_id=qt.t_id where t.tag_name='"+searchTag+"' order by q.post_date desc;");
