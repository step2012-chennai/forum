...
public class ShowQuestionsTest {
    private ApplicationContext context = new ClassPathXmlApplicationContext("file:src/main/webapp/WEB-INF/config.xml");
    ...
    public void tearDown() {
        template.execute("delete from Questions where id is null");
    }

    @Test
    public void shouldRetrieveDataFromTheDataBase() {
        postQuestion.create("thor");
